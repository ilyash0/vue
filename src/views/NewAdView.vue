...
const deleteCharacteristic = (inex) => {
    ...
    <form @submit.prevent="sendForm()" novalidate>
      ...
      <div class="row">
        <div class="mb-3 col-lg-4" v-if="ch.type === 'number'">
          ...
          <input type="text" class="form-control" v-model="ch.number_value">
        </div>
      ...
      <button type="button" class="btn btn-primary" @click.prevent="addCharacteristic()">Добавить характеристику
      </button>
      <hr>
